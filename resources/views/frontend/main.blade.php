        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('uploads/product')}}/{{App\Models\Product::find($cart->product_id)->product_thumbnail}}"
                                alt="Cart product Image"></a>
                        <div class="content">
                            <a href="single-product.html" class="title">{{App\Models\Product::find($cart->product_id)->product_name}}</a>
                            <span class="quantity-price">{{$cart->quantity}} x <span class="amount">BDT {{App\Models\Product::find($cart->product_id)->discount_price}}</span></span>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{asset('frontend_assets')}}/images/product-image/zoom-image/1.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{asset('frontend_assets')}}/images/product-image/zoom-image/2.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{asset('frontend_assets')}}/images/product-image/zoom-image/3.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{asset('frontend_assets')}}/images/product-image/zoom-image/4.jpg" alt="">
                                    </div>
                                </div>
                            </div>
