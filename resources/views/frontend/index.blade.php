                        ...
                        <div class="nav-center">
                            <ul class="product-tab-nav nav align-items-center justify-content-center">
                                ...
                                <li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
                                    href="#tab{{ $category->id }}">{{$category->category_name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
                    ...
                    <div class="tab-content mb-30px0px">
                                        ...
                                        <div class="thumb">
                                            ...
                                            <div class="actions">
                                                ...
                                                <a href="#" class="action quickview" data-link-action="quickview"
                                                    ...
                                                    data-bs-target="#prod{{$product->id}}"><i class="pe-7s-search"></i></a>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-sm-12 col-xs-12 mb-lm-30px mb-md-30px mb-sm-30px">
                                                        ...
                                                        <div class="swiper-container zoom-top">
                                                            <div class="swiper-wrapper">
                                                                @foreach (App\Models\ProductThumbnailMultiple::where('product_id', $product->id)->get() as $product_multiple_image)
                                                                <div class="swiper-slide">
                                                                    <img class="img-responsive m-auto"
                                                                        src="{{asset('uploads/product/product_images')}}/{{ $product_multiple_image->product_multiple_image }}" alt="">
                                                                </div>
                                                                @endforeach
                                                            </div>
                                                        </div>
                        ...
                        <div class="tab-pane fade" id="tab{{ $category->id }}">
                            <div class="row">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            ...
                                            <div class="actions">
                                                ...
                                                <a href="#" class="action quickview" data-link-action="quickview"
                                                    title="Quick view" data-bs-toggle="modal"
                                                    data-bs-target="#pro{{ $product->id }}"><i class="pe-7s-search"></i></a>
                                ...
                                <!-- Category Wise Modal -->
                                <div class="modal modal-2 fade" id="pro{{ $product->id }}" tabindex="-1" role="dialog">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-body">
                                                <div class="row">
                                ...
                                <div class="new-product-wrapper swiper-wrapper">
                                    <div class="new-product-item swiper-slide">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.html" class="image">
                                                    <img src="{{asset('frontend_assets')}}/images/product-image/8.jpg" alt="Product" />
                                                </a>
                                                <span class="badges">
                                                    <span class="new">New</span>
                                                </span>
                                    ...
                                    <div class="new-product-item swiper-slide">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.html" class="image">
                                                    <img src="{{asset('frontend_assets')}}/images/product-image/9.jpg" alt="Product" />
                                                </a>
                                                <span class="badges">
                                    ...
                                    <div class="new-product-item swiper-slide">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.html" class="image">
                                                    <img src="{{asset('frontend_assets')}}/images/product-image/10.jpg" alt="Product" />
                                                </a>
                                                <span class="badges">
                                    ...
                                    <div class="new-product-item swiper-slide">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.html" class="image">
                                                    <img src="{{asset('frontend_assets')}}/images/product-image/11.jpg" alt="Product" />
                                                </a>
                                                <span class="badges">
