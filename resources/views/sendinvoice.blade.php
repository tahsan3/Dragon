                ...
                <div class="mt-3">
                    <div class="table-responsive" style="background:#fb5d5d">
                        <table class="table">
                            ...
                            <tbody>
                                @foreach (App\Models\Order_product_details::where('order_id', $order_id)->get() as $order_details)
                                <tr style="color:white">
                    ...
                    <div class="table-responsive" style="background:#fb5d5d;margin-top:50px">
                        <table class="table">
                            ...
                            <tbody>
                                <tr style="color:white">
                                    <td>{{$data->first()->sub_total}}</td>
                                    <td>{{$data->first()->discount}}</td>
                                    <td>{{$data->first()->delivery_charge}}</td>
                                    <td>{{$data->first()->grand_total}}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
